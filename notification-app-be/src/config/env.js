...
function getConfig() {
  ...
  return Object.freeze({
    ...
    appName: process.env.APP_NAME || 'notification-app-be',
    nodeEnv: process.env.NODE_ENV || 'development',
    notificationUrl: process.env.EVALUATION_NOTIFICATION_URL || 'http://4.224.186.213/evaluation-service/notifications',
    ...
    maxInboxSize: num(process.env.PRIORITY_INBOX_LIMIT, 10),
  });
}
